...
```
# Creates a Deployment with one replica in it.
kubectl create deployment hello-world --image=gcr.io/google-samples/hello-app:1.0   # pulled from Google's container registry
