...
### Create Private Enpoint for Storage Account

Create virtual nic and assign an IP to the storage
...
### Create Record A in DNS zone

Create "A-record" for the Srorage account IP
